pipeline {
    ...
    stages {
        ...
        stage('Deploy to prod') {
            steps {
                echo 'Deploy to prod'
                deploy adapters: [tomcat9(credentialsId: '3eb83963-e106-493f-ac20-ad13f6b35e9f', path: '', url: 'http://ec2-18-130-240-111.eu-west-2.compute.amazonaws.com/:8080/')], contextPath: 'web-1.0', war: '*/target/web-1.0-SNAPSHOT.war'
            }
        }
